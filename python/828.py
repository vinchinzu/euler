#!/usr/bin/env python
"""Adapted from https://github.com/igorvanloo/Project-Euler-Explained/blob/19f85895945a2c9b688f85da142bae13f37dab65/Finished%20Problems/pe00828%20-%20Numbers%20Challenge.py"""
...
def ReadFile():  # Create the inital list
    data = Path("0828_number_challenges.txt").read_text().splitlines()
    datalist = []
    for x in data:
        x = x.rstrip()
        x += ","
