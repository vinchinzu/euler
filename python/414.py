...
Compute sum_{k=2}^{300} S(6k+3) mod 10^18, where S(b) is the sum over all
5-digit base-b numbers of the number of Kaprekar iterations to reach the
Kaprekar constant.
...
def solve():
    ...
    c_file = os.path.join(tmpdir, "p414.c")
    exe_file = os.path.join(tmpdir, "p414")
