...
def solve() -> str:
    ...
    num = (fact_a ** b) * (fact_b ** a)
    
    # Calculate denominator
    fact_ab = factorial(a * b)
    den = fact_ab ** 2
    
    # Calculate decimal value
    # Need enough precision
    getcontext().prec = 50
    val = Decimal(num) / Decimal(den)
    
    # Format: scientific notation rounded to ten significant digits after the decimal point.
    # This corresponds to {:.10e}
    return f"{val:.10e}"
