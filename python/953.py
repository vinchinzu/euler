...
int main() {
    ...
    cpp_file = os.path.join(script_dir, "solution.cpp")
    exe_file = os.path.join(script_dir, "solution")
    ...
    # Compile
    # -O3 for optimization
    # -march=native for extra speed on current hardware
    cmd = ["g++", "-O3", "-march=native", cpp_file, "-o", exe_file]
    try:
