 ...
 *
 * Sieve approach: for each prime p, find n such that p | 2n^2-1,
 * i.e., 2n^2 ≡ 1 (mod p), n^2 ≡ (p+1)/2 (mod p).
 * Use Tonelli-Shanks to find square root mod p.
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
