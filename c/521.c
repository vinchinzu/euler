 ...
 *
 * Lucy DP sieve: compute sum of smallest prime factors for 2..N,
 * using the fact that for each prime p, the count of composites
 * with smallest factor p can be tracked via the sieve.
 */
#include <stdio.h>
#include <stdint.h>
#include <stdlib.h>
