 ...
 *
 * For each prime p <= N, the multiplicative order contribution to lambda
 * involves (p-1) and its prime power factors. We sieve to find the
 * largest lambda value mod 10^9, then add 1.
 */
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
