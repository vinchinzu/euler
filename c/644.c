...
static void ms_remove_val(int val) { if (val < MS_MAX && ms_counts[val] > 0) ms_counts[val]--; }
...
static void active_remove_pid(int pid) {
    active_bits[pid] = 0;
}
